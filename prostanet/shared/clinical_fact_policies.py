...
FACT_FRESHNESS_POLICIES: dict[str, dict[str, Any]] = {
    ...
    "psa_current_date": {"expires": True, "current_days": 90, "aging_days": 180},
    ...
    "castration_resistant": {"expires": True, "current_days": 90, "aging_days": 180},
    ...
    "clinical_tstage": {"expires": True, "current_days": 365, "aging_days": 730},
    ...
    "genomic_classifier_type": {"expires": False, "current_days": None, "aging_days": None},
    ...
    "num_cores_positive": {"expires": False, "current_days": None, "aging_days": None},
    ...
    "age": {"expires": True, "current_days": 365, "aging_days": 730},
    ...
    "on_zoledronate": {"expires": True, "current_days": 180, "aging_days": 365},
    "on_denosumab": {"expires": True, "current_days": 180, "aging_days": 365},
    ...
    "oncologic_state_context": {"expires": True, "current_days": 180, "aging_days": 365},
    "prior_adt": {"expires": False, "current_days": None, "aging_days": None},
    "adt_active": {"expires": True, "current_days": 180, "aging_days": 365},
    "prior_docetaxel": {"expires": False, "current_days": None, "aging_days": None},
    "prior_cabazitaxel": {"expires": False, "current_days": None, "aging_days": None},
    "salvage_local_feasible": {"expires": True, "current_days": 180, "aging_days": 365},
    "prior_radiation": {"expires": False, "current_days": None, "aging_days": None},
    "prior_prostatectomy": {"expires": False, "current_days": None, "aging_days": None},
    "prior_rt_modality": {"expires": False, "current_days": None, "aging_days": None},
    "prior_rt_fields": {"expires": False, "current_days": None, "aging_days": None},
    "prior_rt_dose": {"expires": False, "current_days": None, "aging_days": None},
    "prior_rt_completion_date": {"expires": False, "current_days": None, "aging_days": None},
    "concurrent_adt_history": {"expires": False, "current_days": None, "aging_days": None},
