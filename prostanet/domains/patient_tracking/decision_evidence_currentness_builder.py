...
_FIELD_ALIASES = {
    ...
    "genomic_classifier_type": ["genomic_classifier"],
    "genomic_classifier_result": ["decipher_risk"],
...
_FIELD_DATE_FIELDS = {
    ...
    "genomic_classifier_type": ["genomic_classifier_report_date", "genomic_report_date", "molecular_report_date"],
...
_POLICY_KEY_BY_FIELD = {
    ...
    "genomic_classifier_type": "genomic_classifier_report_date",
