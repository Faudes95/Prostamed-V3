...
LANE_OPTIONAL_FIELDS = {
    "diagnostic_biopsy_readiness": ("family_history", "germline_risk", "phi_value", "fourkscore_value"),
...
FIELD_ALIASES = {
    ...
    "mri_pirads_score": ("mri_pirads_score", "pirads_score", "pirads", "mri_pi_rads"),
    "dre_suspicious": ("dre_suspicious", "dre_abnormal", "digital_rectal_exam_suspicious"),
    "biopsy_status": ("biopsy_status", "planned_biopsy_type", "planned_biopsy_route", "biopsy_date", "biopsy_result"),
    ...
    "psma_pet_status": ("psma_pet_status", "psma_pet_positive_current", "psma_result", "psma_pet_done"),
    "psma_negative_dominant_lesions": (
        "psma_negative_dominant_lesions",
